                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./index.html">Create Profile</a></li>
                            <li><a href="./index-2.html">View Profile</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-graph menu-icon"></i> <span class="nav-text">My Dogs</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./chart-flot.html">Dog Gallery</a></li>
                            <li><a href="./chart-morris.html">Upload a Dog</a></li>
                        </ul>
                    </li>
